...
if(isset($_POST['submit'])){
   ...
   $sql="update `crud2` set id=$id,name='$name',mobile='$mobile',email='$email',password='$password' where id=$id";
   $result=mysqli_query($conn,$sql);   
...
<html lang="en">
 ...
 <div class="form-group">
    <label>Mobile</label>
    <input type="text" class="form-control" placeholder="Enter your your mobile" name="mobile" autocomplete="off" value=<?php echo $mobile; ?>>
 </div>
